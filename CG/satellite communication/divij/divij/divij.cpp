...
{ 
	...
	glLoadIdentity();
	glTranslatef(0.0f,0.0f,-13.0f);
	//glClearCo lor(0.0,1.0,0.0,0);
	glColor3f(1.0,0,0);
	setFont(GLUT_BITMAP_TIMES_ROMAN_24);
	drawstring(-3.0,3.0,-1.0,"SAPTHAGIRI COLLEGE OF ENGINEERING, BENGALURU");
	drawstring(-1.0,2.5,-1.0,"DEPT. OF CSE");
	setFont(GLUT_BITMAP_HELVETICA_18);
	drawstring(-3.1,1.5,-1.0,"COMPUTER GRAPHICS MINI PROJECT - SATELLITE COMMUNICATION");
	setFont(GLUT_BITMAP_9_BY_15);
	drawstring(-4.8,.0,-1.0,"Created by:");
	drawstring(-4.5,-0.5,-1.0,"DIVIJ N (1SG16CS029)");
	drawstring(-4.5,-0.85,-1.0,"CHAITANYA (1SG16CS022)");
	drawstring(2.0,.0,-1.0,"Guided by:");
	drawstring(2.5,-0.5,-1.0,"Dr. Kamalakshi Naganna");
	drawstring(3.0,-0.8,-1.0,"Professor");
	drawstring(2.5,-1.2,-1.0,"Mrs. Anuradha Badage");
	drawstring(3.0,-1.5,-1.0,"Assistant Professor");
	setFont(GLUT_BITMAP_HELVETICA_18);
	drawstring(-3.0,-2.5,-1.0,"* * * * * * * * * * * * * * * PRESS S / s TO START * * * * * * * * * * * * * * *");
...
int main(int argc, char *argv[]) 
{
	...
	glutCreateMenu(menu);
      glutAddMenuEntry("Transmit't'",1);
	glutAddMenuEntry("Revolve'S/s'",2);
